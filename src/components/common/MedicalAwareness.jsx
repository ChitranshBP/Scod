...
const { FiPlay, FiX, FiArrowRight, FiChevronLeft, FiChevronRight, FiYoutube } = FiIcons;
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-6">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                onClick={prevSlide}
                                className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-scod hover:text-white hover:border-scod transition-all duration-300 shadow-sm hover:shadow-md bg-white"
                        ...
                        <a
                            ...
                            className="group flex items-center gap-2 text-scod font-bold text-base hover:text-blue-700 transition-all"
                        >
                            <span>Visit YouTube Channel</span>
                            <SafeIcon icon={FiYoutube} className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </a>
                    </motion.div>
                </div>
                        ...
                        {videos.map((video) => (
                            ...
                            >
                                <div className="group h-full flex flex-col">
                                    {/* Thumbnail Container */}
                                    <div
                                        className="relative rounded-2xl overflow-hidden aspect-video mb-4 shadow-sm cursor-pointer group-hover:shadow-md transition-all duration-300 border border-gray-100 bg-gray-100"
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 bg-black/10 group-hover:bg-black/20 transition-colors duration-300 flex items-center justify-center">
                                            <div className="w-14 h-14 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-sm">
                                                <SafeIcon icon={FiPlay} className="w-5 h-5 text-scod fill-current ml-1" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-grow">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-gray-500 text-xs font-bold uppercase tracking-wider bg-gray-100 px-2 py-1 rounded">{video.category}</span>
                                        </div>
                                        <h3
                                            className="text-lg font-bold text-gray-900 mb-2 group-hover:text-scod transition-colors line-clamp-2"
                                            title={video.title}
                                        >
                                            {video.title}
                                        </h3>
